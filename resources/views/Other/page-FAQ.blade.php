        ...
        <section class="m-b-20x p-b-20x">
            ...
            <div class="bg-white m-b-10x">
                ...
                <div class="p-a-15x font-size-sm text-primary">
                    ...
                    <p class="m-b-0">Click on “Forgot Password” at the Sign in page, and fill in your registered email then we’ll
            ...
            <div class="bg-white m-b-10x">
                ...
                <div class="p-a-15x font-size-sm text-primary">
                    <p class="m-b-15x"><strong>Can I change the order information before the product is
                        shipped?</strong></p>
                    <p class="m-b-15x">Yes, please send us an email WITHIN 24 HOURS of ordering. We can change it for you before we
                        engrave the item or ship your package out.</p>

                    <p class="m-b-15x"><strong>How long will my package be shipped after I place the
                        order?</strong></p>
                    <p class="m-b-15x">For non-personalized products, we need 4 business days to process, while for personalized
                    ...
                    <p class="m-b-15x">As for Registered Airmail, the Logistics website may not update so frequently, therefore we
                    ...
                    <p class="m-b-0">We will send one order confirmation email to you after you complete your purchase. When your
            ...
            <div class="bg-white m-b-10x">
                ...
                <div class="p-a-15x font-size-sm text-primary">
                    ...
                    <p class="m-b-15x">If you receive the wrong-size ring, please contact our customer service for help, we’d love to
                        exchange the size for non-personalized rings. However, you are responsible for all shipping fees
                        (exceptions may apply).</p>
                    <p class="m-b-15x">Unfortunately, we can’t exchange rings which are engraved or customized, therefore, we suggest
                    ...
                    <p class="m-b-15x">We carefully check all shipments and we make sure never to send an empty box out. We suggest that
                    ...
                    <p class="m-b-15x"><strong>Can I return a product because I just don’t like or want
                        it?</strong></p>
                    <p class="m-b-0">Yes, we offer a 30 day free return if you are not 100% satisfied with your purchase. We can help
                        you return the product, but we reserve the right to charge shipping & handling, and restocking
                        fees. For more details, please visit our Return <a href="mailto:service@motif.me" class="text-underLine">Policy</a> Page.</p>
                </div>
            </div>
            ...
            <div class="bg-white m-b-10x">
                ...
                <div class="p-a-15x font-size-sm text-primary">
                    ...
                    <p class="m-b-15x">However, there may be a $50-80 USD surcharge for customization and 15-20 days are needed for
                    ...
                    <p class="m-b-0">Please email us at service@motif.me. Normally our service team will reply you within24 hours, but
            ...
            <div class="bg-white">
                ...
                <div class="p-a-15x font-size-sm text-primary">
                    ...
                    <p class="m-b-15x">For now, we only offer engraving service. There will be an engraving box on the Personalized
                        Products detail page.</p>

                    <p class="m-b-15x"><strong>2. Is personalized jewelry more expensive?</strong></p>
                    <p class="m-b-15x">Not really, we offer personalization service and you can find all the personalized jewelry in the
                    ...
                    <p class="m-b-15x"><strong>4. What part of rings, necklaces and bracelets can be
                        engraved?</strong></p>
                    <p class="m-b-15x">Please note that engravings can only be done on the insides of rings and bracelets and on the
                        backs of pendants.</p>

                    <p class="m-b-15x"><strong>5. How many characters can be engraved?</strong></p>
                    <p class="m-b-15x">In order for the words to be legible, please keep the number of characters within 15.</p>
                    ...
                    <p class="m-b-15x"><strong>7. Can you make a ring, necklace or bracelet if I just give you a
                        picture?</strong></p>
                    <p class="m-b-15x">Yes, we can make jewelry according to pictures you send to us and your other requirements, and we
                    ...
                    <p class="m-b-15x">Sorry, personalized jewelry cannot be returned unless it’s a quality issue. Because personalized
                    ...
                    <p class="m-b-0">For any further queries, please feel free to contact us at <a href="mailto:service@motif.me" class="text-underLine">service@motif.me</a>.
                    </p>
                </div>
            </div>
