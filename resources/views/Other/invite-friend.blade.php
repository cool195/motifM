...
<div id="body-content">
    ...
    <div class="body-container">
        ...
        <section class="reserve-height">
            <article class="bg-white m-b-10x p-a-20x text-center">
                <div class="text-center p-t-20x m-t-20x">
                    <img src="/images/icon/gift-big.png" srcset="/images/icon/gift-big@2x.png 2x,/images/icon/gift-big@3x.png 3x">
                </div>
                <div class="text-center text-primary font-size-sm m-t-10x p-y-20x">Give a friend $20 on Motif,<br/>and get $20 when they order.</div>
