...
<html lang="en">
<head>
    <title>@if(!strstr($_SERVER['HTTP_USER_AGENT'], 'motif-android') && !strstr($_SERVER['HTTP_USER_AGENT'], 'motif-ios')){{'TERMS & CONDITIONS'}}@else{{'MOTIF'}}@endif</title>
    @include('head')
                    ...
                    <section class="m-b-20x p-b-20x reserve-height">
                        ...
                        <div class="bg-white">
                            <div class="p-a-15x font-size-sm text-primary">
                                ...
                                <p class="m-b-15x"><strong>If you enter into any other agreement with us, then these
                                ...
                                <p class="m-b-15x"><strong>1. MODIFICATION TO THESE TERMS</strong></p>
                                <p class="m-b-15x">We reserve the right to update or modify these Terms at any time
                                ...
                                <p class="m-b-15x">If you do not agree to any modification of these Terms, you must
                                    immediately stop
                                ...
                                <p class="m-b-15x">If you ever have any questions or complaints about these Terms, you
                                    should
                                    immediately contact us at service@motif.me.</p>

                                <p class="m-b-15x"><strong>2. USE OF OUR SERVICES</strong></p>
                                <p class="m-b-15x">Our Services belong to us. All text, graphics, sounds, user
                                ...
                                <p class="m-b-15x">The material from Our Services is provided for lawful purposes
                                    only.</p>

                                <p class="m-b-15x"><strong>3. MEMBERSHIP ELIGIBILITY</strong></p>
                                <p class="m-b-15x"><strong class="text-underLine">Age</strong></p>
                                <p class="m-b-15x">Our Services are available only to, and may only be used by,
                                ...
                                <p class="m-b-15x">Individuals under the age of 18 must at all times use Our Services
                                ...
                                <p class="m-b-15x"><strong class="text-underLine">Compliance</strong></p>
                                <p class="m-b-15x">You agree to comply with all local laws regarding online conduct and
                                    acceptable Content, including those more particularly described in the section
                                    entitled Prohibited Content found below.</p>
                                <p class="m-b-15x">You agree to pay all charges incurred by you or any users of your
                                ...
                                <p class="m-b-15x"><strong class="text-underLine">User Account and Password</strong></p>
                                <p class="m-b-15x">If you register for Our Services, you will create an account and will
                                ...
                                <p class="m-b-15x">You are solely responsible for maintaining the confidentiality of the
                                ...
                                <p class="m-b-15x">You agree to immediately notify us of any unauthorized use of your
                                    password or account or any other breach
                                    of security, and to ensure that you exit from your account at the end of each
                                    session. </p>
                                <p class="m-b-15x">We are not and shall not be liable in any manner for any losses
                                ...
                                <p class="m-b-15x"><strong>4. TRANSACTIONS</strong></p>
                                <p class="m-b-15x">You agree to pay all charges incurred by you or any users of your
                                ...
                                <p class="m-b-15x">Prices, products and services may change at our sole and absolute
                                    discretion at any time and for any reason.
                                    Please check Our Services periodically for updated information.</p>
                                <p class="m-b-15x">If we determine any price information is inaccurate, we reserve the
                                ...
                                <p class="m-b-15x">For additional information about our rate(s) or price(s), please
                                    contact us at service@motif.me.</p>

                                <p class="m-b-15x"><strong>5. AUTO-BILLING</strong></p>
                                <p class="m-b-15x">We may provide for an automatic payment plan, in which case your fees
                                    ...
                                    to the following:</p>
                                <p class="m-b-15x">(a) You authorize us and/or our third party service providers to keep
                                    your payment card information on file and
                                    to charge the card on file for the fees or charges incurred. </p>
                                <p class="m-b-15x">(b) We or our third party service providers may email you with the
                                    details of the automatic payment plan.</p>
                                <p class="m-b-15x">(c) If your card account on file is closed or the account number is
                                ...
                                <p class="m-b-15x"><strong>6. TERM AND TERMINATION OF USER ACCOUNT</strong></p>
                                <p class="m-b-15x">These Terms are effective upon your use of Our Services. You may
                                ...
                                <p class="m-b-15x">You agree that we, in our sole and absolute discretion, at any time
                                ...
                                <p class="m-b-15x">We, in our sole and absolute discretion, at any time for any reason
                                ...
                                <p class="m-b-15x"><strong>7. CONSENT TO MONITORING</strong></p>
                                <p class="m-b-15x">We reserve the right to monitor your use and activities on Our
                                ...
                                <p class="m-b-15x"><strong>8. PRIVACY AND USE OF PERSONAL INFORMATION</strong>
                                </p>
                                ...
                                <p class="m-b-15x"><strong>9. POSTING MESSAGES OR CONTENT</strong></p>
                                <p class="m-b-15x">Our Services may contain areas where you can communicate with other
                                ...
                                <p class="m-b-15x">Unless we indicate otherwise, if you do post or submit Content on Our
                                    Services
                                ...
                                <p class="m-b-15x">If you choose to provide us with any feedback, suggestions, or
                                    similar
                                ...
                                <p class="m-b-15x"><strong>10. CONSENT TO ELECTRONIC COMMUNICATIONS</strong>
                                </p>
                                ...
                                <p class="m-b-15x"><strong>11. LINKS TO OTHER WEBSITES AND COMPANIES</strong>
                                </p>
                                ...
                                <p class="m-b-15x"><strong>12. PROHIBITED CONDUCT</strong></p>
                                <p class="m-b-15x">You acknowledge and agree that you are fully responsible and liable
                                    for your
                                ...
                                <p class="m-b-15x">You agree not to use Our Services to engage in any prohibited
                                    conduct, including but
                                    not limited to conduct that violates any applicable law or regulation, our rights,
                                    or the rights of
                                    any third party.</p>
                                <p class="m-b-15x"><strong>USE OF OUR SERVICES FOR THE FOLLOWING ACTIVITIES IS STRICTLY
                                        PROHIBITED:</strong></p>
                                <p class="m-b-15x"><strong>(a) Harm to Minors.</strong>Using Our Services to harm, or
                                    attempt to harm, minors
                                    in any way. </p>
                                <p class="m-b-15x"><strong>(b) Illegal Use.</strong>Using Our Services to transmit any
                                    material that,
                                    intentionally or unintentionally, violates any applicable local, state, national or
                                    international law,
                                    or any related rules or regulations.</p>
                                <p class="m-b-15x"><strong>(c) Invasion of Privacy.</strong> Using Our Services for
                                    activities that invade
                                    another’s privacy. </p>
                                <p class="m-b-15x"><strong>(d) Intellectual Property Right Violations. </strong>Using
                                ...
                                <p class="m-b-15x"><strong>(e) Obscene or Indecent Speech or Materials.</strong>Using
                                ...
                                <p class="m-b-15x"><strong>(f) Harassment, Defamatory or Abusive Language.</strong>Using
                                    Our Services to
                                    ...
                                    harasses another. </p>
                                <p class="m-b-15x"><strong>(g) Hacking or Unauthorized Access.</strong>Using Our
                                ...
                                <p class="m-b-15x"><strong>(h) Distribution of Computer Viruses, Trojan Horses or Other
                                ...
                                <p class="m-b-15x"><strong>(i) Facilitating a Violation of these Terms.</strong>Using
                                ...
                                <p class="m-b-15x"><strong>(j) Unsolicited Commercial Email/Unsolicited Bulk
                                ...
                                <p class="m-b-15x"><strong>(k) Collection of Personal Data.</strong>Using Our Services
                                    to collect, or attempt
                                    to collect, personal information about third parties or us without their knowledge
                                    or consent. </p>
                                <p class="m-b-15x"><strong>(l) Resale.</strong>The sale, transfer or rental of Our
                                    Services to customers,
                                    clients or other third parties, either directly or as part of a service or product
                                    created for resale.
                                </p>

                                <p class="m-b-15x"><strong>13. OUR PROPRIETARY RIGHTS</strong>
                                </p>
                                <p class="m-b-15x">You acknowledge and agree that all Content included in or made
                                ...
                                <p class="m-b-15x">You also acknowledge and agree that all graphics, logos, page
                                ...
                                <p class="m-b-15x">You acknowledge and agree that Our Services and any software used in
                                ...
                                <p class="m-b-15x"><strong>14. COPYRIGHT POLICY & PROCESS FOR ALLEGATION OF COPYRIGHT
                                        INFRINGEMENT</strong></p>
                                <p class="m-b-15x">We respect the intellectual property rights of others and expect our
                                    users to do the same.
                                    We may terminate access to Our Services for users whom we believe to be infringers,
                                    at our sole discretion.
                                </p>
                                <p class="m-b-15x">It is our policy to respond expeditiously to claims of infringement.
                                ...
                                <p class="m-b-15x">If you believe in good faith that your copyrighted material has been
                                    ...
                                    section. </p>
                                <p class="m-b-15x">Please also note that under Section 512(f) of the Copyright Act any
                                    ...
                                    a notification. </p>
                                <p class="m-b-15x">To file a copyright infringement notification with us, you will need
                                    to send a written
                                    communication that includes substantially the following:</p>
                                <p class="m-b-15x">(a) A physical or electronic signature of a person authorized to act
                                    on behalf of the owner
                                    of an exclusive copyright interest that is allegedly infringed.
                                </p>
                                <p class="m-b-15x">(b) A description of the copyrighted work claimed to have been
                                    ...
                                    works.</p>
                                <p class="m-b-15x">(c) Identification of the material that is claimed to be infringing
                                ...
                                <p class="m-b-15x">(d) Contact information, including identification of the copyright
                                    owner, your name, address,
                                    telephone number and email address.</p>
                                <p class="m-b-15x">(e) A statement that the complaining party has a good faith belief
                                    that use of the material
                                    in the manner complained of is not authorized by the copyright owner, its agent or
                                    the law.
                                </p>
                                <p class="m-b-15x">(f) A statement by you, made under penalty of perjury, that the
                                ...
                                <p class="m-b-15x text-underLine">
                                    Copyright Agent:
                                </p>
                                <p class="m-b-15x">
                                    Motif Group LLC<br/>
                                ...
                                <p class="m-b-15x"><strong>15. DISCLAIMER OF WARRANTIES</strong></p>
                                <p class="m-b-15x">YOU UNDERSTAND AND AGREE THAT YOUR USE OF OUR SERVICES ARE AT YOUR
                                    SOLE RISK. SUCH SERVICES
                                    AND THE MATERIALS AVAILABLE THROUGH IT ARE PROVIDED ON AN “AS IS” AND “AS AVAILABLE”
                                    BASIS.</p>
                                <p class="m-b-15x">TO THE FULLEST EXTENT PERMISSIBLE PURSUANT TO APPLICABLE LAW, WE AND
                                    ...
                                    TERMS.</p>
                                <p class="m-b-15x">WE ARE NOT RESPONSIBLE FOR THE CONDUCT, WHETHER ONLINE OR OFFLINE, OF
                                ...
                                <p class="m-b-15x">YOU FURTHER ACKNOWLEDGE AND AGREE THAT (A) OUR SERVICES MAY NOT BE
                                ...
                                <p class="m-b-15x"><strong>16. LIMITATION OF LIABILITY; TIME FOR COMMENCING
                                        ACTION</strong></p>
                                <p class="m-b-15x">YOU EXPRESSLY UNDERSTAND AND AGREE THAT UNDER NO CIRCUMSTANCES SHALL
                                ...
                                <p class="m-b-15x">IN THE EVENT THAT YOU OBJECT TO ANY OF THESE TERMS OR ARE
                                ...
                                <p class="m-b-15x">SOME JURISDICTIONS DO NOT ALLOW THE LIMITATION OR EXCLUSION OF
                                    ...
                                    PERMITTED BY LAW.</p>
                                <p class="m-b-15x">YOU AGREE THAT ANY CLAIM OR CAUSE OF ACTION ARISING OUT OF OR RELATED
                                ...
                                <p class="m-b-15x"><strong>17. RELEASE</strong></p>
                                <p class="m-b-15x">In the event that you have a dispute with a third party, you agree to
                                    release us
                                ...
                                <p class="m-b-15x">Furthermore, you expressly waive any rights you may have under
                                    ...
                                    with the debtor.” </p>
                                <p class="m-b-15x">To the extent that we attempt to resolve a dispute between users,
                                    which we are not
                                    required to do, we will make such attempt in good faith based on our policies and
                                    these Terms. </p>

                                <p class="m-b-15x"><strong>18. INDEMNITY</strong></p>
                                <p class="m-b-15x">You agree to promptly and completely indemnify and hold harmless us,
                                ...
                                <p class="m-b-15x"><strong>19. GOVERNING LAW</strong></p>
                                <p class="m-b-15x">These Terms shall be construed in accordance with, and governed by,
                                    the internal laws of the State of California without reference to any choice-of-law
                                    rules.
                                </p>

                                <p class="m-b-15x"><strong>20. ARBITRATION OF DISPUTES </strong></p>
                                <p class="m-b-15x">If any dispute, difference or disagreement of any kind whatsoever
                                ...
                                <p class="m-b-15x">Any Dispute not resolved by mutual discussions (as set forth above)
                                ...
                                <p class="m-b-15x">The Disputing Parties intend to preserve their rights under any
                                    ...
                                    effect.</p>
                                <p class="m-b-15x">Any arbitration proceeding to enforce, confirm, modify or vacate a
                                ...
                                <p class="m-b-15x"><strong>The parties involved in the Dispute expressly intend and
                                ...
                                <p class="m-b-15x"><strong>21. GENERAL</strong></p>
                                <p class="m-b-15x">Although the Website and Mobile Sites are accessible worldwide, our
                                ...
                                <p class="m-b-15x">We shall have no liability for any failure or delay resulting from
                                ...
                                <p class="m-b-15x"><strong>BY USING OUR SERVICES, YOU REPRESENT THAT YOU HAVE THE LEGAL
                                        CAPACITY TO ACCEPT AND AGREE TO THESE TERMS.</strong></p>
                                <p class="m-b-15x">These Terms shall not be construed as creating a partnership, joint
