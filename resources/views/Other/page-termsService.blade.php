...
<!-- 主体内容 -->
    ...
    <!-- 服务条款 -->
        <section>
            <article class="font-size-md text-main p-x-15x p-y-10x"><strong>TERMS OF SERVICE</strong>
            </article>
            <div class="bg-white">
                <div class="p-a-15x font-size-sm text-primary">
                    <p class="m-b-15x"><strong>OVERVIEW</strong></p>
                    <p class="m-b-15x">This website is operated by Motif.me. Throughout the site, the terms “we”, “us”
                        and “our” refer
                        to Motif.me. Motif.me offers this website, including all information, tools and services
                    ...
                    <p class="m-b-15x">By visiting our site and/ or purchasing something from us, you engage in our
                        “Service” and agree
                    ...
                    <p class="m-b-15x">Please read these Terms of Service carefully before accessing or using our
                    ...
                    <p class="m-b-15x">Any new features or tools which are added to the current store shall also be
                    ...
                    <p class="m-b-15x"><strong>SECTION 1 - ONLINE STORE TERMS</strong></p>
                    <p class="m-b-15x">By agreeing to these Terms of Service, you represent that you are at least the
                        age of majority in
                    ...
                    <p class="m-b-15x"><strong>SECTION 2 - GENERAL CONDITIONS</strong></p>
                    <p class="m-b-15x">We reserve the right to refuse service to anyone for any reason at any time.<br>
                    ...
                    <p class="m-b-15x"><strong>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF
                            INFORMATION</strong></p>
                    <p class="m-b-15x">We are not responsible if information made available on this site is not
                    ...
                    <p class="m-b-15x"><strong>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</strong></p>
                    <p class="m-b-15x">Prices for our products are subject to change without notice.<br>
                    ...
                    <p class="m-b-15x"><strong>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</strong></p>
                    <p class="m-b-15x">Certain products or services may be available exclusively online through the
                        website. These
                    ...
                    <p class="m-b-15x"><strong>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</strong></p>
                    <p class="m-b-15x">We reserve the right to refuse any order you place with us. We may, in our sole
                        discretion, limit
                    ...
                    <p class="m-b-15x">You agree to provide current, complete and accurate purchase and account
                        information for all
                    ...
                    <p class="m-b-15x">For more detail, please review our Returns Policy.</p>

                    <p class="m-b-15x"><strong>SECTION 7 - OPTIONAL TOOLS</strong></p>
                    <p class="m-b-15x">We may provide you with access to third-party tools over which we neither monitor
                        nor have any
                    ...
                    <p class="m-b-15x"><strong>SECTION 8 - THIRD-PARTY LINKS</strong></p>
                    <p class="m-b-15x">Certain content, products and services available via our Service may include
                        materials from
                        third-parties.<br>
                    ...
                    <p class="m-b-15x"><strong>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</strong></p>
                    <p class="m-b-15x">If, at our request, you send certain specific submissions (for example contest
                        entries) or
                        ...
                        otherwise objectionable or violates any party’s intellectual property or these Terms of Service.<br>
                    ...
                    <p class="m-b-15x"><strong>SECTION 10 - PERSONAL INFORMATION</strong></p>
                    <p class="m-b-15x">Your submission of personal information through the store is governed by our
                        Privacy Policy. To
                        view our <a href="#" class="text-underLine">Privacy Policy</a>.
                    </p>

                    <p class="m-b-15x"><strong>SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</strong></p>
                    <p class="m-b-15x">Occasionally there may be information on our site or in the Service that contains
                        typographical
                    ...
                    <p class="m-b-15x"><strong>SECTION 12 - PROHIBITED USES</strong></p>
                    <p class="m-b-15x">In addition to other prohibitions as set forth in the Terms of Service, you are
                        prohibited from
                    ...
                    <p class="m-b-15x"><strong>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</strong>
                    </p>
                    <p class="m-b-15x">We do not guarantee, represent or warrant that your use of our service will be
                        uninterrupted,
                        ...
                        In no case shall MOTIF-Design, our directors, officers, employees, affiliates, agents,
                    ...
                    <p class="m-b-15x"><strong>SECTION 14 - INDEMNIFICATION</strong></p>
                    <p class="m-b-15x">You agree to indemnify, defend and hold harmless Motif.me and our parent,
                        subsidiaries,
                    ...
                    <p class="m-b-15x"><strong>SECTION 15 - SEVERABILITY</strong></p>
                    <p class="m-b-15x">In the event that any provision of these Terms of Service is determined to be
                        unlawful, void or
                    ...
                    <p class="m-b-15x"><strong>SECTION 16 - TERMINATION</strong></p>
                    <p class="m-b-15x">The obligations and liabilities of the parties incurred prior to the termination
                        date shall
                    ...
                    <p class="m-b-15x"><strong>SECTION 17 - ENTIRE AGREEMENT</strong></p>
                    <p class="m-b-15x">The failure of us to exercise or enforce any right or provision of these Terms of
                        Service shall
                    ...
                    <p class="m-b-15x"><strong>SECTION 18 - GOVERNING LAW</strong></p>
                    <p class="m-b-15x">These Terms of Service and any separate agreements whereby we provide you
                        Services shall be
                        governed by and construed in accordance with the laws of <a href="#" class="text-underLine">160
                            Greentree Drive, Suite #101, Dover,
                            DE 19904, US</a>.
                    </p>

                    <p class="m-b-15x"><strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong></p>
                    <p class="m-b-15x">You can review the most current version of the Terms of Service at any time at
                        this page.<br>
                    ...
                    <p class="m-b-15x"><strong>SECTION 20 - CONTACT INFORMATION</strong></p>
                    <p class="m-b-15x">Questions about the Terms of Service should be sent to us at <a
                                href="mailto:service@motif.me" class="text-underLine">info@motif.me</a>.
                    </p>
                </div>
            </div>
