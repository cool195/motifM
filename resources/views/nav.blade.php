...
<nav class="nav-menu">
    ...
    <ul class="nav bg-white m-t-10x">
        ...
        <li class="nav-item">
            <a href= @if(Session::has('user')) "/wish" @else "/login" @endif class="flex flex-alignCenter flex-fullJustified p-a-15x menu" {{--data-remodal-target="download-modal"--}} {{--id="menu-wishlist"--}}>
                <div class="font-size-sm text-primary flex flex-alignCenter"><i
