        ...
        <div class="body-container">
            ...
            <section class="p-b-20x reserve-height">
                ...
                <form class="bg-white" id="addressInfo" method="get" action="/cart/countrylist">
                    ...
                    <hr class="hr-base m-a-0">
                    <fieldset>
                        <input class="form-control form-control-block p-a-15x font-size-sm" data-optional="true" name="state" type="text" value="{{$input['state']}}" placeholder="State (optional)">
                    </fieldset>
                    <hr class="hr-base m-a-0">
                    <fieldset>
                    ...
                    <hr class="hr-base m-a-0">
                    <fieldset>
                        <input class="form-control form-control-block p-a-15x font-size-sm" maxlength="20" data-optional="false" name="tel" type="text" value="{{$input['telephone']}}" placeholder="Phone">
                    </fieldset>
                    <hr class="hr-base m-a-0">
                    <fieldset>
