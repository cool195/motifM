...
<!-- 主体内容 -->
    ...
    <!-- 订单结算确认信息 -->
        <section class="reserve-height"
                 data-impr='{{ config('app.clk_url') }}/log.gif?t=order.100001&m=H5_M2016-1&pin={{Session::get('user.pin')}}&uuid={{Session::get('user.uuid')}}&v={"orderno":"{{ $order['sub_order_no'] }}","version":"1.0.1","ver":"9.2","src":"H5"}'>
