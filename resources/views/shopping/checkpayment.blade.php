...
<head>
    ...
    @include('head')
    <link rel="stylesheet" href="{{env('CDN_Static')}}/styles/orderCheckout-payment.css{{'?v='.config('app.version')}}">
...
<script src="{{env('CDN_Static')}}/scripts/orderCheckout-payment.js{{'?v='.config('app.version')}}"></script>
@include('global')
</html>
