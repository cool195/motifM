            ...
            <section class="p-b-20x">
                ...
                <section class="cartList bg-white">
                    ...
                    <div class="cartList-item p-a-10x @if(1 !== $showSku['stock_status']) disabled @endif">
                            ...
                            <div class="p-l-10x flex-width">
                                <article class="flex flex-fullJustified">
                                 <!--<h6 class="text-main font-size-md p-r-10x">
                                    ...
                                    <h6 class="text-main font-size-md p-r-10x"><strong>{{$showSku['main_title']}}</strong></h6>
                        ...
                        <div class="flex flex-alignCenter flex-fullJustified p-y-10x">
                            <div class="flex">
                                <a class="btn btn-cartUpdate btn-sm" data-remodal-target="modal" data-sku="{{$showSku['sku']}}" data-action="delsku">Delete</a>
                                <a href="#" class="btn btn-cartUpdate btn-sm" data-product-move="save" data-sku="{{$showSku['sku']}}">Save for Later</a>
                            </div>
                ...
                <section class="bg-white m-t-10x p-a-10x">
                    <div class="flex flex-rightJustify text-primary font-size-sm">
                        <span class="p-r-5x">Items({{$cartData['total_sku_qtty'] }}): </span><strong>${{$cartData['total_amount']}}</strong>
                    </div>
                    <div class="flex flex-rightJustify text-primary font-size-sm">
                ...
                <section class="cartList bg-white">
                    ...
                    <div class="cartList-item p-a-10x @if( 1 !== $showSku['stock_status'] ) disabled @endif">
                        ...
                        <div class="flex p-y-10x">
                            ...
                            <a class="btn btn-cartUpdate btn-sm" data-product-move="movetocart" data-sku="{{$showSku['sku']}}">Move to Bag</a>
                        </div>
                    </div>
					@endforeach
                </section>
