            ...
            <aside class="bg-white m-b-10x">
                @if(isset($data['list']))
                    @foreach($data['list'] as $addr)
                        ...
                        <a class="flex flex-alignCenter flex-fullJustified font-size-sm text-primary p-x-15x p-y-10x"
                           href="#">
                            <div class="flex flex-alignCenter">
                                <div class="p-r-15x"><i class="iconfont icon-delete icon-size-md text-warming"></i>
                                </div>
                                <address class="m-b-0">
                                    <div>{{$addr['email']}}</div>
                            ...
                            @if(1 == $addr['isDefault'])
                                <div class="flex flex-alignCenter"><span class="text-common p-r-20x">Primary</span><i
                                            class="iconfont icon-check icon-size-sm text-common"></i></div>
                            @endif
