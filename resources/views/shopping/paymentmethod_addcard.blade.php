...
<!-- 主体内容 -->
    ...
    <!-- 添加支付方式 -->
                ...
                <form method="">
                    <fieldset class="bg-white m-b-10x">
                        <div class="flex flex-alignCenter flex-fullJustified">
                            <input class="form-control form-control-block p-a-15x font-size-sm" type="text"
                                   placeholder="Card Number">
                            <div class="p-x-15x flex flex-alignCenter">
                                <i class="iconfont icon-delete icon-size-md text-common p-r-10x"></i>
                                <span><img src="/images/payment/icon-card.png"
                                ...
                                <div class="col-xs-6 border-right">
                                    <div class="flex flex-alignCenter flex-fullJustified p-x-10x">
                                        <div class="flex flex-alignCenter flex-fullJustified">
                                            ...
                                            <input class="form-control form-control-block p-y-15x p-x-0 font-size-sm"
        ...
        -->
        <section>
            <form class="cardform-container" id="card-form">
