...
<!-- 主体内容 -->
    ...
    <!-- 图片详情 --><!-- 弹出图片轮播 -->
        ...
        <section class="container-fluid p-x-0">
            ...
            @if(Session::has('user'))
                <span class="wish-item p-r-10x p-t-10x"><i class="iconfont text-common btn-wish @if(in_array($data['spu'], $wishlist->wishlist())){{'active'}}@endif" data-spu="{{$data['spu']}}"></i></span>
            @else
