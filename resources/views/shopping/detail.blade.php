            ...
            @else
                ...
                @endif
                    ...
                    @if(1 == $data['sale_type'])
                       ...
                       @if($data['skuPrice']['skuPromotion']['remain_time'] >= 0 || $data['isPutOn']==0 || !empty($data['spuStock']))
                        <section class="limited-content"
                            ...
                            <div class="bg-white m-b-10x">
                                ...
                                @if($data['isPutOn']==0 || !empty($data['spuStock']))
                    ...
                    <div class="row" data-control="modalButton">
                        <div class="col-xs-12">
                            <div class="btn btn-primary btn-block @if(!(!empty($data['vasBases']) && empty($data['spuAttrs'])))disabled @endif"
                                 ...
                                 @else data-action="PATCH"@endif>@if(1 == $data['sale_type']) Pre Order Now @else Add to
                                Bag @endif
                            </div>
                        </div>
                        {{--<div class="col-xs-6">--}}
