        ...
        <div class="body-container">
            ...
            <section class="p-b-20x reserve-height">
                ...
                <form class="bg-white" id="addressInfo" name="addressInfo" method="get" action="/user/countrylist">
                    ...
                    <hr class="hr-base m-a-0">
                    <fieldset>
                        <input class="form-control form-control-block p-a-15x font-size-sm" name="zip" type="text" maxlength="10" data-optional="false" data-role="zip code" value="{{$input['zip']}}"  placeholder="Zip Code">
                    </fieldset>
                    <hr class="hr-base m-a-0">
                    <fieldset>
