      ...
      <div class="row">
        <div class="col-xs-6 col-xs-offset-1 p-y-40x">
          <div class="content p-a-30x text-center">
            ...
            <p class="font-size-md p-t-10x sanBold">Visit <a style="text-decoration:underline" href="javascript:;">motif.me/rae</a> in your mobile browser, or download the app!</p>
