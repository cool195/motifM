            ...
            <div class="bg-white p-a-5x">
                ...
                <div class="p-x-10x p-t-5x p-b-15x">
                    @if(isset($designer['youtube_link']))
                        <a href="motif://o.c?a=outurl&url={{$designer['youtube_link']}}" target="_blank" class="p-r-20x">
                    ...
                    @elseif(isset($designer['facebook_link']))
                        <a href="motif://o.c?a=outurl&url={{$designer['facebook_link']}}" target="_blank" class="p-r-20x">
                    ...
                    @elseif(isset($designer['instagram_link']))
                        <a href="motif://o.c?a=outurl&url={{$designer['instagram_link']}}" target="_blank" class="p-r-20x">
