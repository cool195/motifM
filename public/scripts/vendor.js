...
(function($) {
    ...
    function switchDownload() {
        var Android = 'https://play.google.com/store/apps/details?id=me.motif.motif',
            ...
            case 1:
                ...
                if($('#allDownload-container').length > 0) {
                    $('#allDownload-img').attr({
                        'src': '/images/daily/h5-ad.png',
                        'srcset': '/images/daily/h5-ad@2x.png 2x, /images/daily/h5-ad@3x.png 3x'
                    });
                }
                break;
            case 0:
                ...
                if($('#allDownload-container').length > 0) {
                    $('#allDownload-img').attr({
                        'src': '/images/daily/h5-adGoogle.png',
                        'srcset': '/images/daily/h5-adGoogle@2x.png 2x, /images/daily/h5-adGoogle@3x.png 3x'
                    });
                }
                break;
            case -1:
